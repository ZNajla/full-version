    ...
    export const LISTITEMS: any[] = [
        ...
        {"url":"/dashboard", "name":"Dashboard 2", "icon":"ft-home"},
        ...
        {"url":"/horizontaltimeline", "name":"Horizontal Timeline", "icon":"ft-credit-card"},
        {"url":"/timeline-vertical-center", "name":"Vertical Timeline Center", "icon":"ft-sidebar"},
        {"url":"/timeline-vertical-left", "name":"Vertical Timeline Left", "icon":"ft-sidebar"},
        {"url":"/timeline-vertical-right", "name":"Vertical Timeline Right", "icon":"ft-sidebar"},
